...
SPONSOR_DATA = [
    ...
    # ── Large ────────────────────────────────────────────────────
    ("Red Bull",            "large",  "#1C2E6E", "#CC2229", None),   # Austrian, no code
    ...
    ("Etihad Airways",      "large",  "#C5A028", "#1C1C1C", None),   # UAE
    ("Emirates",            "large",  "#D71A21", "#C5A028", None),   # UAE
    ...
    ("Singha",              "medium", "#003087", "#FFD700", None),   # Thai
    ("Rakuten",             "medium", "#BF0000", "#F0F0F0", "JP"),
    ("NetApp",              "medium", "#005073", "#F0F0F0", "US"),
    ("BWT",                 "medium", "#E91E8C", "#F0F0F0", None),   # Austrian
